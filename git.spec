...
Version  : 2.11.1
Release  : 79
URL      : https://www.kernel.org/pub/software/scm/git/git-2.11.1.tar.gz
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.11.1.tar.gz
...
%prep
%setup -q -n git-2.11.1
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1486155655
