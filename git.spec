...
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.46.2.tar.gz
...
%prep
%setup -q -n git-2.46.2
cd %{_builddir}/git-2.46.2
%patch -P 1 -p1
pushd ..
cp -a git-2.46.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727122705
