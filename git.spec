...
Version  : 2.45.2
Release  : 235
URL      : https://www.kernel.org/pub/software/scm/git/git-2.45.2.tar.gz
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.45.2.tar.gz
...
%prep
%setup -q -n git-2.45.2
cd %{_builddir}/git-2.45.2
%patch -P 1 -p1
pushd ..
cp -a git-2.45.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717426644
