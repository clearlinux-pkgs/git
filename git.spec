...
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.44.0.tar.xz
...
%prep
%setup -q -n git-2.44.0
cd %{_builddir}/git-2.44.0
%patch -P 1 -p1
pushd ..
cp -a git-2.44.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708963108
