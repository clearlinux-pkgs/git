...
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.46.1.tar.gz
...
%prep
%setup -q -n git-2.46.1
cd %{_builddir}/git-2.46.1
%patch -P 1 -p1
pushd ..
cp -a git-2.46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726332875
