...
Version  : 2.50.0
Release  : 247
URL      : https://www.kernel.org/pub/software/scm/git/git-2.50.0.tar.gz
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.50.0.tar.gz
...
%prep
%setup -q -n git-2.50.0
cd %{_builddir}/git-2.50.0
pushd ..
cp -a git-2.50.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750169491
...
cp %{_builddir}/git-%{version}/compat/nedmalloc/License.txt %{buildroot}/usr/share/package-licenses/git/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90 || :
cp %{_builddir}/git-%{version}/contrib/persistent-https/LICENSE %{buildroot}/usr/share/package-licenses/git/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/git-%{version}/contrib/subtree/COPYING %{buildroot}/usr/share/package-licenses/git/06877624ea5c77efe3b7e39b0f909eda6e25a4ec || :
cp %{_builddir}/git-%{version}/reftable/LICENSE %{buildroot}/usr/share/package-licenses/git/29ae6b2cafd8b8dc18b829c1af20f28c24f15664 || :
cp %{_builddir}/git-%{version}/sha1dc/LICENSE.txt %{buildroot}/usr/share/package-licenses/git/f0197ae0a546d825bcd59ba21034f36272080a4a || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/V3/usr/libexec/git-core/git-backfill
...
/V3/usr/libexec/git-core/git-diff-pairs
...
/V3/usr/libexec/git-core/git-replay
...
/usr/share/package-licenses/git/29ae6b2cafd8b8dc18b829c1af20f28c24f15664
...
/usr/share/man/man1/git-backfill.1
...
/usr/share/man/man1/git-fsmonitor--daemon.1
...
/usr/share/man/man1/git-replay.1
...
/usr/share/man/man1/git-version.1
...
/usr/share/man/man5/gitformat-bundle.5
/usr/share/man/man5/gitformat-chunk.5
/usr/share/man/man5/gitformat-commit-graph.5
/usr/share/man/man5/gitformat-index.5
/usr/share/man/man5/gitformat-pack.5
/usr/share/man/man5/gitformat-signature.5
...
/usr/share/man/man5/gitprotocol-capabilities.5
/usr/share/man/man5/gitprotocol-common.5
/usr/share/man/man5/gitprotocol-http.5
/usr/share/man/man5/gitprotocol-pack.5
/usr/share/man/man5/gitprotocol-v2.5
...
/usr/share/man/man7/gitpacking.7
