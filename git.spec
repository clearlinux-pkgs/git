...
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.34.0.tar.xz
...
%prep
%setup -q -n git-2.34.0
cd %{_builddir}/git-2.34.0
%patch1 -p1
%patch2 -p1
pushd ..
cp -a git-2.34.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637019472
...
cp %{_builddir}/git-2.34.0/COPYING %{buildroot}/usr/share/package-licenses/git/3ee0019d4f4ea0a9d3f50800833f30dc14e2968e
cp %{_builddir}/git-2.34.0/compat/nedmalloc/License.txt %{buildroot}/usr/share/package-licenses/git/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
cp %{_builddir}/git-2.34.0/contrib/persistent-https/LICENSE %{buildroot}/usr/share/package-licenses/git/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/git-2.34.0/contrib/subtree/COPYING %{buildroot}/usr/share/package-licenses/git/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/git-2.34.0/sha1dc/LICENSE.txt %{buildroot}/usr/share/package-licenses/git/f0197ae0a546d825bcd59ba21034f36272080a4a
pushd ../buildavx2/
%make_install_v3
popd
%make_install
