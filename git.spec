...
Version  : 2.38.1
Release  : 211
URL      : https://www.kernel.org/pub/software/scm/git/git-2.38.1.tar.xz
Source0  : https://www.kernel.org/pub/software/scm/git/git-2.38.1.tar.xz
...
%prep
%setup -q -n git-2.38.1
cd %{_builddir}/git-2.38.1
%patch1 -p1
%patch2 -p1
pushd ..
cp -a git-2.38.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666131065
